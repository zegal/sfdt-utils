...
const { ZipArchive, ZipArchiveItem } = require("./ej2-compression.cjs"),
  { XmlWriter } = require("./ej2-file-utils.cjs.js"),
  { isNullOrUndefined } = require("@syncfusion/ej2-base");
const { Dictionary } = require("./ej2-dictionary.cjs");
const { HelperMethods } = require("./editor-helper.cjs");
/**
...
var WordExport = /** @class */ (function() {
  function WordExport() {
    ...
    this.numberingContentType =
      "application/vnd.openxmlformats-officedocument.wordprocessingml.numbering+xml";
    this.stylesContentType =
      "application/vnd.openxmlformats-officedocument.wordprocessingml.styles+xml";
    this.webSettingsContentType =
      "application/vnd.openxmlformats-officedocument.wordprocessingml.webSettings+xml";
    this.appContentType =
      "application/vnd.openxmlformats-officedocument.extended-properties+xml";
    this.coreContentType =
      "application/vnd.openxmlformats-package.core-properties+xml";
    this.customContentType =
      "application/vnd.openxmlformats-officedocument.custom-properties+xml";
    this.customXmlContentType =
      "application/vnd.openxmlformats-officedocument.customXmlProperties+xml";
    this.relationContentType =
    ...
    this.documentRelType =
      "http://schemas.openxmlformats.org/officeDocument/2006/relationships/officeDocument";
    this.numberingRelType =
    ...
    this.customXmlRelType =
      "http://schemas.openxmlformats.org/officeDocument/2006/relationships/customXml";
    this.customUIRelType =
      "http://schemas.microsoft.com/office/2006/relationships/ui/extensibility";
    this.attachedTemplateRelType =
      "http://schemas.openxmlformats.org/officeDocument/2006/relationships/attachedTemplate";
    this.chartColorStyleRelType =
    ...
    this.wordMLControlRelType =
      "http://schemas.microsoft.com/office/2006/relationships/activeXControlBinary";
    this.wordMLDiagramContentType =
  ...
  WordExport.prototype.serializeSectionProperties = function(writer, section) {
    ...
    // }
    if (
      section.sectionFormat !== undefined &&
      section.sectionFormat.differentFirstPage
    ) {
    ...
    if (
      !isNullOrUndefined(section.sectionFormat) &&
      section.sectionFormat.bidi
    ) {
  ...
  WordExport.prototype.serializePageSize = function(writer, pageSetup) {
    ...
    writer.writeAttributeString(
      ...
      this.roundToTwoDecimal(
        pageSetup.pageWidth * this.twentiethOfPoint
      ).toString()
    );
    // tslint:disable-next-line:max-line-length
    writer.writeAttributeString(
      ...
      this.wNamespace,
      this.roundToTwoDecimal(
        pageSetup.pageHeight * this.twentiethOfPoint
      ).toString()
    );
  ...
  WordExport.prototype.serializePageMargins = function(writer, pageSetup) {
    ...
    writer.writeAttributeString(
      ...
      this.wNamespace,
      this.roundToTwoDecimal(
        pageSetup.headerDistance * this.twentiethOfPoint
      ).toString()
    );
    // tslint:disable-next-line:max-line-length
    writer.writeAttributeString(
      ...
      this.wNamespace,
      this.roundToTwoDecimal(
        pageSetup.footerDistance * this.twentiethOfPoint
      ).toString()
    );
  ...
  WordExport.prototype.serializeSectionType = function(
    writer,
    sectionBreakCode
  ) {
  ...
  WordExport.prototype.serializeBodyItems = function(
    writer,
    blockCollection,
    isLastSection
  ) {
  ...
  WordExport.prototype.serializeBodyItem = function(
    writer,
    item,
    isLastSection
  ) {
  ...
  WordExport.prototype.serializeParagraph = function(
    writer,
    paragraph,
    isLastSection
  ) {
    ...
    if (
      !isLastSection &&
      sec.hasOwnProperty("sectionFormat") &&
  ...
  WordExport.prototype.serializeParagraphItems = function(writer, paraItems) {
    ...
    for (var i = 0; i < paraItems.length; i++) {
      ...
      if (item.characterFormat) {
        isBdo =
          !isNullOrUndefined(item.characterFormat.bdo) &&
          item.characterFormat.bdo !== "None";
  ...
  WordExport.prototype.serializeBiDirectionalOverride = function(
    writer,
    characterFormat
  ) {
    ...
    writer.writeAttributeString(
      ...
      "val",
      this.wNamespace,
      characterFormat.bdo.toLowerCase()
    );
  };
    ...
    if (editElement.hasOwnProperty("editableRangeStart")) {
      ...
      if (editElement.columnFirst && editElement.columnFirst !== -1) {
        writer.writeAttributeString(
          ...
          "colFirst",
          this.wNamespace,
          editElement.columnFirst.toString()
        );
      }
      if (editElement.columnLast && editElement.columnLast !== -1) {
        writer.writeAttributeString(
          ...
          "colLast",
          this.wNamespace,
          editElement.columnLast.toString()
        );
      }
    }
    writer.writeAttributeString(
  ...
  WordExport.prototype.serializeDrawingGraphicsChart = function(writer, chart) {
    ...
    writer.writeAttributeString(
      ...
      "id",
      undefined,
      (this.mDocPrID++).toString()
    );
    writer.writeAttributeString(
      undefined,
      "name",
      undefined,
      this.getNextChartName()
    );
  ...
  WordExport.prototype.serializeWorkBook = function() {
    ...
    writer.writeAttributeString(
      ...
      "id",
      undefined,
      this.getNextExcelRelationShipID()
    );
      ...
      for (var column = 0; column < seriesLength; column++) {
        ...
        if (row !== 0 && column === 0) {
          ...
          if (isNullOrUndefined(isString) && format === "m/d/yyyy") {
            ...
            (!isString && !isNullOrUndefined(isString)) ||
            isScatterType
          ) {
            type = "n";
          } else {
  ...
  WordExport.prototype.serializeExcelContentTypes = function() {
    ...
    var zipArchiveItem = new ZipArchiveItem(
      writer.buffer,
  ...
  WordExport.prototype.serializeChartData = function(writer, chart) {
    ...
    if (!isNullOrUndefined(this.chart.chartTitle)) {
      ...
      this.serializeTextProperties(
        writer,
        this.chart.chartTitleArea,
        this.chart.chartTitle
      );
  ...
  WordExport.prototype.serializeChartPlotArea = function(writer, chart) {
    ...
    var isPieTypeSerialization =
      serializationChartType === "pieChart" ||
      serializationChartType === "doughnutChart";
    var isScatterType =
      serializationChartType === "scatterChart" ||
      serializationChartType === "bubbleChart";
    writer.writeStartElement("c", serializationChartType, this.chartNamespace);
    if (serializationChartType === "barChart") {
      var barDiv = "";
      if (
        chart.chartType === "Column_Clustered" ||
        chart.chartType === "Column_Stacked" ||
    ...
    for (var i = 0; i < chart.chartSeries.length; i++) {
      ...
      if (chart.chartType === "Pie" || chart.chartType === "Doughnut") {
        ...
        this.parseChartSeriesColor(
          writer,
          series.dataPoints,
          serializationChartType
        );
      }
      if (serializationChartType === "scatterChart") {
      ...
      if (serializationChartType === "scatterChart") {
        ...
        this.serializeShapeProperties(
          writer,
          series.dataPoints[i].fill.foreColor,
          false
        );
      }
    ...
    var isStackedPercentage =
      ...
      type === "Area_Stacked_100" ||
      type === "Bar_Stacked_100" ||
      type === "Line_Stacked_100" ||
  ...
  WordExport.prototype.serializeChartErrorBar = function(writer, series) {
    ...
    writer.writeAttributeString(
      ...
      "val",
      undefined,
      errorBar.direction.toLowerCase()
    );
  ...
  WordExport.prototype.serializeCategoryAxis = function(
    writer,
    format,
    isStackedPercentage
  ) {
    ...
    this.serializeAxis(
      writer,
      "335263360",
      this.chart.chartPrimaryCategoryAxis,
      formatCode,
      isStackedPercentage
    );
    if (!isScatterType) {
  ...
  WordExport.prototype.serializeValueAxis = function(
    writer,
    format,
    isStackedPercentage
  ) {
  ...
  WordExport.prototype.parseChartDataLabels = function(writer, dataLabels) {
    ...
    writer.writeAttributeString(
      ...
      "val",
      undefined,
      isLeaderLines.toString()
    );
    writer.writeEndElement(); // end of showBubbleSize
    writer.writeEndElement(); // end of dLbls
  };
  WordExport.prototype.serializeShapeProperties = function(
    writer,
    color,
    isLine
  ) {
    ...
    var isScatterType =
      chartType === "Scatter_Markers" || chartType === "Bubble";
    // serialize shape
    writer.writeStartElement("c", "spPr", this.chartNamespace);
  ...
  WordExport.prototype.serializeTextProperties = function(
    writer,
    title,
    chartTitleName
  ) {
  ...
  WordExport.prototype.serializeChartTitleFont = function(
    writer,
    fontSize,
    fill,
    fontName
  ...
  WordExport.prototype.serializeChartSolidFill = function(
    writer,
    fill,
    isSeriesFill
  ) {
  ...
  WordExport.prototype.parseChartSeriesColor = function(
    writer,
    dataPoints,
    chartType
  ) {
  ...
  // chart data value
  WordExport.prototype.serializeChartCategory = function(
    writer,
    chart,
    cacheType
  ) {
  ...
  // chart value
  WordExport.prototype.serializeChartValue = function(
    writer,
    valueSheet,
    chartType
  ) {
  ...
  WordExport.prototype.serializeChartYValue = function(
    writer,
    valueType,
    valueSheet
  ) {
  ...
  WordExport.prototype.chartType = function(chart) {
    ...
    if (
      ...
      chartType === "Line_Markers_Stacked" ||
  ...
  WordExport.prototype.startsWith = function(sourceString, startString) {
    return (
      ...
      sourceString.substring(0, startString.length) === startString
    );
  };
  ...
  WordExport.prototype.updateShapeId = function(picture) {
    ...
    if (this.headerFooter) {
      ...
      if (id === "") {
        if (
          tOwner.hasOwnProperty("sectionFormat") ||
          tOwner.hasOwnProperty("inlines")
        ) {
  ...
  WordExport.prototype.serializeRowFormat = function(writer, row) {
    ...
    if (row.rowFormat.height > 0) {
      ...
      var height = this.roundToTwoDecimal(
        row.rowFormat.height * this.twentiethOfPoint
      ).toString();
    ...
    if (gridBefore > 0) {
      ...
      switch (rowFormat.gridBeforeWidthType) {
        case "Percent":
          var width = this.roundToTwoDecimal(
            rowFormat.gridBeforeWidth * this.percentageFactor
          ).toString();
          writer.writeAttributeString("w", "val", this.wNamespace, width);
          writer.writeAttributeString("w", "type", this.wNamespace, "pct");
          break;
        case "Point":
          var pointWidth = this.roundToTwoDecimal(
            rowFormat.gridBeforeWidth * this.twipsInOnePoint
          ).toString();
    ...
    if (gridAfter > 0) {
      ...
      switch (rowFormat.gridAfterWidthType) {
        case "Percent":
          var width = this.roundToTwoDecimal(
            rowFormat.gridAfterWidth * this.percentageFactor
          ).toString();
          writer.writeAttributeString("w", "val", this.wNamespace, width);
          writer.writeAttributeString("w", "type", this.wNamespace, "pct");
          break;
        case "Point":
          var pointWidth = this.roundToTwoDecimal(
            rowFormat.gridAfterWidth * this.twipsInOnePoint
          ).toString();
          writer.writeAttributeString("w", "val", this.wNamespace, pointWidth);
          writer.writeAttributeString("w", "type", this.wNamespace, "dxa");
          break;
  ...
  WordExport.prototype.serializeCell = function(writer, cell) {
    ...
    if (
      this.mVerticalMerge.containsKey(
        cell.columnIndex + cell.cellFormat.columnSpan - 1 + 1
      ) &&
      (this.row.cells.indexOf(cell) === this.row.cells.length - 1 ||
        this.row.cells.indexOf(cell) === cell.columnIndex) &&
  ...
  WordExport.prototype.serializeCellFormat = function(
    writer,
    cellFormat,
    ensureMerge,
    endProperties
  ...
  WordExport.prototype.serializeCellWidth = function(writer, cell) {
    ...
    if (cf.preferredWidthType === "Percent") {
      ...
      writer.writeAttributeString(
        ...
        this.wNamespace,
        this.roundToTwoDecimal(
          cf.preferredWidth * this.percentageFactor
        ).toString()
      );
      ...
      writer.writeAttributeString(
        ...
        this.wNamespace,
        this.roundToTwoDecimal(
          cf.preferredWidth * this.twipsInOnePoint
        ).toString()
      );
  ...
  WordExport.prototype.serializeCellMerge = function(writer, cellFormat) {
    ...
    var prevIndex =
      cellIndex > 0
        ? this.row.cells[cellIndex - 1].columnIndex
        : cell.columnIndex;
    ...
    if (cellFormat.rowSpan > 1) {
      ...
      if (this.mVerticalMerge.containsKey(collKey) && isserialized) {
        this.createMerge(writer, collKey, cell);
      }
    }
  };
  ...
  WordExport.prototype.serializeColumnSpan = function(collKey, writer) {
    if (
      this.mGridSpans.keys.length > 0 &&
      this.mGridSpans.containsKey(collKey)
    ) {
      ...
      writer.writeAttributeString(
        ...
        "val",
        this.wNamespace,
        this.mGridSpans.get(collKey).toString()
      );
      writer.writeEndElement();
    }
  };
  ...
  WordExport.prototype.serializeTableCellDirection = function(
    writer,
    cellFormat
  ) {
  ...
  WordExport.prototype.serializeCellVerticalAlign = function(
    writer,
    alignment
  ) {
  ...
  WordExport.prototype.serializeShading = function(writer, format = {}) {
    ...
    writer.writeAttributeString(
      ...
      "fill",
      this.wNamespace,
      this.getColor(format.backgroundColor)
    );
    if (format.foregroundColor === "empty") {
      ...
      writer.writeAttributeString(
        ...
        "color",
        this.wNamespace,
        this.getColor(format.foregroundColor)
      );
    }
    writer.writeAttributeString(
      "w",
      "val",
      this.wNamespace,
      this.getTextureStyle(format.textureStyle)
    );
    writer.writeEndElement();
    // }
  };
  ...
  WordExport.prototype.serializeBorder = function(
    writer,
    border,
    tagName,
    multiplier
    ...
    writer.writeAttributeString(
      ...
      "sz",
      this.wNamespace,
      this.roundToTwoDecimal(sz).toString()
    );
    writer.writeAttributeString(
      undefined,
      "space",
  ...
  WordExport.prototype.serializeCellSpacing = function(writer, format) {
    if (!isNullOrUndefined(format.cellSpacing) && format.cellSpacing > 0) {
      ...
      writer.writeAttributeString(
        ...
        this.wNamespace,
        this.roundToTwoDecimal(
          format.cellSpacing * this.twentiethOfPoint
        ).toString()
      );
      writer.writeAttributeString(undefined, "type", this.wNamespace, "dxa");
      writer.writeEndElement();
  ...
  WordExport.prototype.serializeTableWidth = function(writer, table) {
    ...
    if (table.tableFormat.preferredWidthType === "Percent") {
      ...
      writer.writeAttributeString(
        ...
        "w",
        this.wNamespace,
        (table.tableFormat.preferredWidth * this.percentageFactor).toString()
      );
      writer.writeAttributeString(undefined, "type", this.wNamespace, "pct");
    } else if (table.tableFormat.preferredWidthType === "Point") {
      var tableWidth = Math.round(
        table.tableFormat.preferredWidth * this.twipsInOnePoint
      );
      writer.writeAttributeString(
        undefined,
        "w",
  ...
  WordExport.prototype.serializeTextRange = function(
    writer,
    span,
    previousNode
  ) {
    ...
    if (span.text === "\t") {
      ...
      var isField =
        !isNullOrUndefined(previousNode) &&
        previousNode.hasOwnProperty("fieldType") &&
        previousNode.fieldType !== 2;
      writer.writeStartElement(
        undefined,
        isField ? "instrText" : "t",
        this.wNamespace
  ...
  WordExport.prototype.serializeParagraphFormat = function(
    writer,
    paragraphFormat = {},
    paragraph
  ) {
    ...
    this.serializeParagraphAlignment(
      writer,
      paragraphFormat.textAlignment,
      paragraphFormat.bidi
    );
    if (
      !isNullOrUndefined(paragraphFormat.tabs) &&
      paragraphFormat.tabs.length > 0
    ) {
  ...
  WordExport.prototype.serializeTab = function(writer, tabStop) {
    ...
    if (tabStop.position === 0 && tabStop.deletePosition !== 0) {
      ...
      writer.writeAttributeString(
        ...
        "val",
        this.wNamespace,
        this.getTabJustification(tabStop.tabJustification)
      );
    }
    if (!isNullOrUndefined(tabStop.tabLeader) && tabStop.tabLeader !== "None") {
      writer.writeAttributeString(
        ...
        "leader",
        this.wNamespace,
        this.getTabLeader(tabStop.tabLeader)
      );
    }
    writer.writeAttributeString(
      "w",
  ...
  WordExport.prototype.serializeListFormat = function(writer, lf = {}) {
    if (
      !isNullOrUndefined(lf.listId) ||
      !isNullOrUndefined(lf.listLevelNumber)
    ) {
  ...
  //     writer.writeEndElement();
  // }
  WordExport.prototype.serializeParagraphAlignment = function(
    writer,
    txtAlignment,
    isBidi
  ) {
  ...
  WordExport.prototype.serializeParagraphSpacing = function(
    writer,
    paragraphFormat
  ) {
    ...
    if (!isNullOrUndefined(paragraphFormat.beforeSpacing)) {
      writer.writeAttributeString(
        ...
        this.wNamespace,
        this.roundToTwoDecimal(
          paragraphFormat.beforeSpacing * this.twentiethOfPoint
        ).toString()
      );
    }
    ...
    if (!isNullOrUndefined(paragraphFormat.afterSpacing)) {
      ...
      writer.writeAttributeString(
        ...
        this.wNamespace,
        this.roundToTwoDecimal(
          paragraphFormat.afterSpacing * this.twentiethOfPoint
        ).toString()
      );
    }
    ...
    if (!isNullOrUndefined(paragraphFormat.lineSpacingType)) {
      ...
      var lineSpacingValue =
        paragraphFormat.lineSpacingType === "AtLeast" ||
        paragraphFormat.lineSpacingType === "Exactly"
          ? this.roundToTwoDecimal(
              paragraphFormat.lineSpacing * this.twentiethOfPoint
            )
          : this.roundToTwoDecimal(paragraphFormat.lineSpacing * 240);
  ...
  WordExport.prototype.serializeIndentation = function(
    writer,
    paragraphFormat
  ) {
    ...
    if (!isNullOrUndefined(paragraphFormat.leftIndent)) {
      ...
      writer.writeAttributeString(
        ...
        this.wNamespace,
        this.roundToTwoDecimal(
          paragraphFormat.leftIndent * this.twipsInOnePoint
        ).toString()
      );
    }
    if (!isNullOrUndefined(paragraphFormat.rightIndent)) {
      ...
      writer.writeAttributeString(
        ...
        this.wNamespace,
        this.roundToTwoDecimal(
          paragraphFormat.rightIndent * this.twipsInOnePoint
        ).toString()
      );
    }
    if (!isNullOrUndefined(paragraphFormat.firstLineIndent)) {
      if (paragraphFormat.firstLineIndent < 0) {
        ...
        writer.writeAttributeString(
          ...
          this.wNamespace,
          this.roundToTwoDecimal(
            -1 * paragraphFormat.firstLineIndent * this.twipsInOnePoint
          ).toString()
        );
      } else {
        // tslint:disable-next-line:max-line-length
        writer.writeAttributeString(
          ...
          this.wNamespace,
          this.roundToTwoDecimal(
            paragraphFormat.firstLineIndent * this.twipsInOnePoint
          ).toString()
        );
      }
    }
  ...
  WordExport.prototype.serializeCharacterFormat = function(
    writer,
    characterFormat = {}
  ) {
    writer.writeStartElement(undefined, "rPr", this.wNamespace);
    ...
    if (!isNullOrUndefined(characterFormat.fontFamily)) {
      ...
      writer.writeAttributeString(
        ...
        "cs",
        this.wNamespace,
        characterFormat.fontFamilyBidi
      );
    ...
    if (!isNullOrUndefined(characterFormat.fontColor)) {
      ...
      writer.writeAttributeString(
        ...
        "val",
        this.wNamespace,
        this.getColor(characterFormat.fontColor)
      );
      writer.writeEndElement();
    }
    if (!isNullOrUndefined(characterFormat.fontSize)) {
      ...
      writer.writeAttributeString(
        ...
        "val",
        this.wNamespace,
        this.roundToTwoDecimal(characterFormat.fontSize * 2).toString()
      );
      writer.writeEndElement();
    }
    if (!isNullOrUndefined(characterFormat.fontSizeBidi)) {
      ...
      writer.writeAttributeString(
        ...
        "val",
        this.wNamespace,
        this.roundToTwoDecimal(characterFormat.fontSizeBidi * 2).toString()
      );
      writer.writeEndElement();
    }
    if (
      !isNullOrUndefined(characterFormat.highlightColor) &&
      ...
      writer.writeAttributeString(
        ...
        "val",
        this.wNamespace,
        this.getHighlightColor(characterFormat.highlightColor)
      );
      writer.writeEndElement();
    }
    if (
      !isNullOrUndefined(characterFormat.underline) &&
      ...
      writer.writeAttributeString(
        ...
        "val",
        this.wNamespace,
        this.getUnderlineStyle(characterFormat.underline)
      );
      writer.writeEndElement();
    }
  ...
  WordExport.prototype.getColor = function(color = "FFFFFF") {
    if (color.length > 0) {
      if (color[0] === "#") {
  ...
  WordExport.prototype.serializeAbstractListStyles = function(
    writer,
    listStyles
  ) {
    for (var i = 0; i < listStyles.length; i++) {
      ...
      writer.writeAttributeString(
        ...
        "abstractNumId",
        this.wNamespace,
        abstractList.abstractListId.toString()
      );
  ...
  WordExport.prototype.generateHex = function() {
    return (Math.floor(Math.random() * (4000000000 - 270000000)) + 270000000)
      .toString(16)
      .toUpperCase();
  };
  ...
  WordExport.prototype.serializeListLevel = function(
    writer,
    listLevel,
    levelIndex
  ) {
    ...
    writer.writeAttributeString(
      ...
      "val",
      this.wNamespace,
      this.getLevelPattern(listLevel.listLevelPattern)
    );
    writer.writeEndElement();
  ...
  WordExport.prototype.serializeLevelText = function(
    writer,
    listLevel,
    lvlIndex
  ) {
  ...
  WordExport.prototype.serializeHFRelations = function(
    hfId,
    headerFooterRelsPath
  ) {
  ...
  WordExport.prototype.serializeFooter = function(
    footer,
    id,
    headerFooterPath,
    headerFooterRelsPath
  ...
  WordExport.prototype.serializeDocumentRelations = function() {
    ...
    var zipArchiveItem = new ZipArchiveItem(
      writer.buffer,
      this.wordRelationPath
    );
    this.mArchive.addItem(zipArchiveItem);
    this.headerFooter = undefined;
  };
  // serialize chart relations
  WordExport.prototype.serializeChartDocumentRelations = function(
    charts,
    writer
  ) {
    if (charts.length > 0) {
  ...
  WordExport.prototype.serializeChartRelations = function() {
    ...
    var chartRelationPath =
      this.chartPath + "/_rels/chart" + this.chartCount + ".xml.rels";
    var chartExcelPath =
      "../embeddings/Microsoft_Excel_Worksheet" + this.chartCount + ".xlsx";
    // tslint:disable-next-line:max-line-length
    this.serializeRelationShip(
      writer,
      this.getNextChartRelationShipID(),
      this.packageRelType,
      chartExcelPath
    );
    this.serializeRelationShip(
    ...
    if (images.length > 0) {
      ...
      for (var i = 0; i < keys.length; i++) {
        ...
        if (isNullOrUndefined(base64ImageString)) {
          ...
          var imageBlob = new Buffer(this.encodedString(formatClippedString));
  ...
  WordExport.prototype.serializeExternalLinkImages = function(writer) {
    ...
    for (var i = 0; i < this.externalImages.keys.length; i++) {
      this.serializeRelationShip(
        ...
        keys[i],
        this.imageRelType,
        this.externalImages.get(keys[i])
      );
    }
  };
  ...
  WordExport.prototype.serializeRelationShip = function(
    writer,
    relationshipID,
    relationshipType,
    targetPath
    ...
    writer.writeAttributeString(
      ...
      "Target",
      undefined,
      targetPath.replace("\\", "/").replace("\v", "")
    );
    // tslint:disable-next-line:max-line-length
    if (
      relationshipType === this.hyperlinkRelType ||
      this.startsWith(targetPath, "http://") ||
      this.startsWith(targetPath, "https://") ||
      this.startsWith(targetPath, "file:///")
    ) {
      // Uri targetUri;
  ...
  WordExport.prototype.serializeContentTypes = function(contentType) {
    ...
    // }
    if (
      this.documentImages.length > 0 ||
      this.externalImages.length > 0 ||
      this.headerFooterImages.length > 0
    ) {
    ...
    if (this.chartCount > 0) {
      var count = 1;
      this.serializeDefaultContentType(
        writer,
        "xlsx",
      ...
      while (count <= this.chartCount) {
        this.serializeOverrideContentType(
          writer,
          "word/charts/chart" + count + ".xml",
          this.chartsContentType
        );
        this.serializeOverrideContentType(
          writer,
          "word/charts/colors" + count + ".xml",
          this.chartColorStyleContentType
        );
        count++;
      }
  ...
  // Serializes the HeaderFooter content types.
  WordExport.prototype.serializeHeaderFootersContentType = function(
    writer,
    headerFooterType
  ) {
    var contentType;
  ...
  WordExport.prototype.serializeOverrideContentType = function(
    writer,
    partName,
    contentType
  ) {
  ...
  WordExport.prototype.serializeDefaultContentType = function(
    writer,
    extension,
    contentType
  ) {
