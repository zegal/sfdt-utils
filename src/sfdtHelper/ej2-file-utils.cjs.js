...
var Save = /** @class */ (function() {
  ...
  Save.save = function(fileName, buffer) {
    if (fileName === null || fileName === undefined || fileName === "") {
      throw new Error(
        "ArgumentException: fileName cannot be undefined, null or empty"
      );
    }
    ...
    if (this.isMicrosoftBrowser);
      ...
      var downloadLink = document.createElementNS(
...
var XmlWriter = /** @class */ (function() {
  ...
  function XmlWriter() {
    ...
    this.namespaceStack[0].set(
      "xmlns",
      "http://www.w3.org/2000/xmlns/",
      "Special"
    );
    this.namespaceStack.push(new Namespace());
    this.namespaceStack[1].set(
      "xml",
  ...
  XmlWriter.prototype.writeProcessingInstruction = function(name, text) {
    if (name === undefined || name === null || name.length === 0) {
      throw new Error(
        "ArgumentException: name should not be undefined, null or empty"
      );
    }
    this.checkName(name);
    ...
    if (name.length === 3 && name === "xml") {
      if (this.currentState !== "Initial") {
        ...
        throw new Error(
          "InvalidArgumentException: Cannot write XML declaration.WriteStartDocument method has already written it"
        );
      }
    }
   ...
   * @throws InvalidOperationException
   */
  XmlWriter.prototype.writeStartElement = function(
    prefix,
    localName,
    namespace
  ) {
  ...
  XmlWriter.prototype.writeEndElement = function() {
    ...
    this.writeEndElementInternal(
      this.elementStack[top].prefix,
      this.elementStack[top].localName
    );
   ...
   */
  XmlWriter.prototype.writeElementString = function(
    prefix,
    localName,
    namespace,
    value
   ...
   * @param {string} value - value of element
   */
  XmlWriter.prototype.writeAttributeString = function(
    prefix,
    localName,
    namespace,
    value
  ...
  XmlWriter.prototype.writeProcessingInstructionInternal = function(
    name,
    text
  ) {
    this.bufferText += "<?";
  ...
  XmlWriter.prototype.writeStartAttribute = function(
    prefix,
    localName,
    namespace,
    value
    ...
    this.checkName(localName);
    this.writeStartAttributePrefixAndNameSpace(
      prefix,
      localName,
      namespace,
      value
  ...
  XmlWriter.prototype.writeStartAttributePrefixAndNameSpace = function(
    prefix,
    localName,
    namespace,
    value
    ...
    this.writeStartAttributeSpecialAttribute(
      prefix,
      localName,
      namespace,
      value
  ...
  XmlWriter.prototype.writeStartAttributeSpecialAttribute = function(
    prefix,
    localName,
    namespace,
    value
  ...
  XmlWriter.prototype.writeStartElementInternal = function(
    prefix,
    localName,
    namespace
  ) {
    ...
    this.elementStack.push(new XmlElement());
    this.elementStack[top].set(
      prefix,
      localName,
      namespace,
      this.namespaceStack.length - 1
    );
    this.pushNamespaceImplicit(prefix, namespace);
  ...
  XmlWriter.prototype.writeEndElementInternal = function(prefix, localName) {
    if (this.contentPos !== this.bufferText.length + 1) {
      ...
      this.bufferText = this.bufferText.substring(
        0,
        this.bufferText.length - 1
      );
      this.bufferText += " />";
    }
  };
  XmlWriter.prototype.writeStartAttributeInternal = function(
    prefix,
    localName,
    namespaceName
  ) {
  ...
  XmlWriter.prototype.startElementContent = function() {
    ...
    for (var i = this.namespaceStack.length - 1; i > start; i--) {
      if (this.namespaceStack[i].kind === "NeedToWrite") {
        this.writeNamespaceDeclaration(
          this.namespaceStack[i].prefix,
          this.namespaceStack[i].namespaceUri
        );
      }
    }
    this.bufferText += ">";
  ...
  XmlWriter.prototype.pushNamespaceImplicit = function(prefix, ns) {
    ...
    if (existingNsIndex !== -1) {
      if (
        existingNsIndex >
        this.elementStack[this.elementStack.length - 1].previousTop
      ) {
        ...
        if (this.namespaceStack[existingNsIndex].kind === "Special") {
          ...
          kind =
            this.namespaceStack[existingNsIndex].namespaceUri === ns
              ? "Implied"
              : "NeedToWrite";
        }
      }
      ...
      if (
        (ns === "http://www.w3.org/XML/1998/namespace" && prefix !== "xml") ||
  ...
  XmlWriter.prototype.addAttribute = function(
    prefix,
    localName,
    namespaceName
  ) {
    ...
    for (var i = 0; i < top; i++) {
      if (
        this.attributeStack[i].isDuplicate(prefix, localName, namespaceName)
      ) {
        throw new Error("XmlException: duplicate attribute name");
      }
    }
  };
  XmlWriter.prototype.skipPushAndWrite = function(
    prefix,
    localName,
    namespace
  ) {
...
var XmlElement = /** @class */ (function() {
   ...
   */
  XmlElement.prototype.set = function(
    prefix,
    localName,
    namespaceUri,
    previousTop
...
var XmlAttribute = /** @class */ (function() {
   ...
   * @param {string} localName - attribute localName
   */
  XmlAttribute.prototype.isDuplicate = function(
    prefix,
    localName,
    namespaceUri
  ) {
