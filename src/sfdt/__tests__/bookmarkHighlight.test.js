...
describe('SFDT: Bookmark highlight', () => {
	it('should work for nested bookmarks', () => {
		...
		expect(data.sections[0].blocks[0].inlines[2].characterFormat.highlightColor).toEqual(DONE)
		expect(data.sections[0].blocks[0].inlines[4].characterFormat.highlightColor).toEqual(DONE)
	})
	...
	it('should process bookmarks in tables', () => {
		...
		expect(data.sections[0].blocks[2].rows[0].cells[0].blocks[0].inlines[1].characterFormat.highlightColor).toEqual(NOT_DONE)
		...
		expect(data.sections[0].blocks[2].rows[0].cells[0].blocks[0].inlines[1].characterFormat.highlightColor).toEqual(DONE)
	})
	...
	it('should process bookmarks in tables when bookmark starts in different cell', () => {
		...
		expect(data.sections[0].blocks[3].rows[0].cells[0].blocks[1].inlines[0].characterFormat.highlightColor).toEqual(NOT_DONE)
		...
		expect(data.sections[0].blocks[3].rows[0].cells[0].blocks[1].characterFormat.highlightColor).toEqual(DONE) // table format
		expect(data.sections[0].blocks[3].rows[0].cells[0].blocks[1].inlines[0].characterFormat.highlightColor).toEqual(DONE) // inline format
	})
	...
	it('should also check bullet and indent highlights', () => {
		...
		bookmarkHighlight(data, bookmarks)
		expect(data.sections[0].blocks[5].characterFormat.highlightColor).toEqual(DONE)
	})
