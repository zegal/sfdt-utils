	...
	sections: [
		{
          ...
          {characterFormat: {}, bookmarkType: 0, name: 'DATA::5678::LOOP.name'},
          {characterFormat: {bidi: false}, text: 'entity1name'},
          {characterFormat: {}, bookmarkType: 1, name: 'DATA::5678::LOOP.name'}]
				},
				{
					paragraphFormat: {
						leftIndent: 36,
					...
					inlines: [
						...
						{characterFormat: {}, bookmarkType: 1, name: 'LOOP::1c300d80-8143-47d6-b771-0836ea44d6ac::entity'}
					]
				}
			],
			headersFooters: {}
