...
describe('toggleBookmark', function() {
  ...
  describe('Nested', function() {
    test('Toggle parent off', function() {
      const nestedBookmarkSfdt = getSFDT(
        false,
        nestedConditionListWithParentOnOneChildOff
      );
      ...
      const toggledOff = toggleBookmark(
        nestedBookmarkSfdt,
        'COND::dafe554d-08b5-463f-a40c-cf5e260be606',
        false
      );
    ...
    test('Toggle parent on', function() {
      const nestedBookmarkSfdt = getSFDT(
        false,
        nestedConditionWithParentOffOneChildOff
      );
      ...
      const toggledOn = toggleBookmark(
        nestedBookmarkSfdt,
        'COND::dafe554d-08b5-463f-a40c-cf5e260be606'
      );
    ...
    test('Toggle parent off along with one child off', () => {
      ...
      const toggledOffChild = toggleBookmark(
        toggledOff,
        'COND::cf6913ce-0e3b-4657-a164-88ab7c18a875'
      );
  ...
  describe('Nested + Toggle off x2', function() {
    test('Toggle off x2', function() {
      ...
      // console.log('TOGGLE STARTING---------------------------------')
      const toggledOff2 = toggleBookmark(
        toggledOff,
        'COND::dafe554d-08b5-463f-a40c-cf5e260be606',
        false
      );
